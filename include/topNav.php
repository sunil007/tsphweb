	...
	<div class="agileits_w3layouts_banner_nav">
		<nav class="navbar navbar-default">
			<div class="navbar-header navbar-left">
				...
				<h1><a class="navbar-brand img-responsive" href="index.php"><img src="images\logo_2022.jpg" alt="TSPH-Logo" style="height: 80px;position: absolute;z-index: 999;background: none;border-radius: 10px;"></a></h1>
			</div>
					...
					<ul class="nav navbar-nav menu__list">
						...
						<li class="dropdown menu__item <?php echo (isset($_SESSION['pageName']) && $_SESSION['pageName'] == 'results')?"menu__item--current": "" ?>"><a href="result_2021.php" class="dropdown-toggle menu__link" data-toggle="dropdown">Results<b class="caret"></b></a>
							<ul class="dropdown-menu agile_short_dropdown ">
								<li><a href="result_2024.php">2024 Results</a></li>
